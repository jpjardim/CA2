...
public interface IList <T> {
     ...
     */
    public void addAtIndex(int index, T element);//throws an IndexOutOfBounds exception where appropriate
     ...
     */
    public T removeAtIndex(int index);//throws an IndexOutOfBoundsException where appropriate
     ...
     */
    public boolean removeElement(T elem);//throws an IndexOutOfBoundsException where appropriate
